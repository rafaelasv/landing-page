...
const cases = [
  ...
  },
  {
    ...
    tagline: "Sistema que recebe candidatos no WhatsApp, conduz a triagem por conversa e extrai dados do currículo automaticamente — sem intervenção humana.",
    meta: {
      papel: "Desenvolvedora & Automatizadora",
      periodo: "2026 · em andamento",
      tipo: "Freelance",
      stack: "n8n · Evolution API · DeepSeek · Redis · PostgreSQL",
    },
    contexto: "Uma empresa de recrutamento e estágios recebia candidatos por WhatsApp e fazia toda a triagem de forma manual — lendo mensagens, pedindo dados, avaliando perfis um por um. O volume de vagas abertas crescia, mas o processo continuava o mesmo.",
    problema: "Recrutadores faziam triagem por conversa no WhatsApp, copiavam dados de candidatos para planilhas na mão e perdiam informações entre mensagens. O processo não escalava — cada candidato exigia atenção manual do início ao fim.",
    ...
    steps: [
      {
        ...
        desc: "Agente conversacional que recebe o candidato no WhatsApp, identifica a vaga de interesse, conduz a triagem com perguntas estruturadas e classifica automaticamente: apto, reprovado ou desistente. Usa DeepSeek como LLM com prompt customizado e exemplos few-shot, Redis para agrupar mensagens fragmentadas (debounce), e PostgreSQL para manter o estado da conversa entre interações. Reengajamento automático: 24h sem resposta gera lembrete, 72h encerra como desistência.",
      },
      {
        n: "02",
        title: "Automatizei a extração de dados curriculares",
        desc: "Sub-workflow acionado quando o candidato envia o currículo pelo WhatsApp. A IA extrai 18 campos estruturados (nome, contato, formação, experiências, habilidades) direto do texto do documento, sem intervenção humana — dados prontos para consulta no banco.",
      },
      {
        n: "03",
        title: "Adaptei o portal de vagas",
        desc: "A partir de uma base existente, customizei o portal para o contexto do projeto — ajustando a estrutura para funcionar junto com o agente de triagem e o fluxo de candidaturas.",
      },
    ],
    metrics: [
      ...
      { n: "notificação", l: "automática para recrutadores quando candidato é classificado como apto" },
    ],
    links: [],
  },
]
