          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed text-gray-900">
                Sou uma desenvolvedora frontend em aprendizado contínuo, apaixonada por transformar ideias em realidade digital. Estou explorando React, Next.js e TypeScript,
                e busco criar interfaces que combinam funcionalidade e design impactante.
              </p>
              <p className="text-lg leading-relaxed text-gray-900">
                Acredito que a tecnologia deve ser acessível e bonita, por isso me dedico a desenvolver experiências que não apenas funcionam bem,
